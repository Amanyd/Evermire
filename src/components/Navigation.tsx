      ...
      <div className="">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-1">
            <Link href="/posts" className="text-[#f8f5f2] hover:text-[#eac6b8] px-2 py-2 rounded-md text-sm font-medium">
              Nest
            </Link>
            <Link href="/analytics" className="text-[#f8f5f2] hover:text-[#eac6b8] px-2 py-2 rounded-md text-sm font-medium">
              Pulse
            </Link>
            <Link href="/chat" className="text-[#f8f5f2] hover:text-[#eac6b8] px-2 py-2 rounded-md text-sm font-medium">
              Whisper
            </Link>
            <Link href="/timeline" className="hidden sm:block text-[#f8f5f2] hover:text-[#eac6b8] px-2 py-2 rounded-md text-sm font-medium">
              Moments
            </Link>
            <button
